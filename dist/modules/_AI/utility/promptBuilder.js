...
exports.buildLeagueShufflePrompt = buildLeagueShufflePrompt;
exports.buildGroupShufflePrompt = buildGroupShufflePrompt;
exports.buildKnockoutPrompt = buildKnockoutPrompt;
exports.buildPosterPrompt = buildPosterPrompt;
exports.buildTeamPowerPrompt = buildTeamPowerPrompt;
exports.buildPredictionPrompt = buildPredictionPrompt;
exports.buildTransferAnnouncementPrompt = buildTransferAnnouncementPrompt;
exports.buildAnnouncementPrompt = buildAnnouncementPrompt;
exports.buildErrorAnalysisPrompt = buildErrorAnalysisPrompt;
function buildLeagueShufflePrompt(fixture) {
    return `
...
function buildGroupShufflePrompt(groups) {
    return `
...
function buildKnockoutPrompt(bracket) {
    return `
...
function buildTeamPowerPrompt(input) {
...
function buildTransferAnnouncementPrompt(input) {
    return `
...
function buildErrorAnalysisPrompt(input) {
    return `
